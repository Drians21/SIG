...
<head>
    ...
    <nav>
        ...
        <div>
            <h2 style='text-align: center'>Jumlah Guru Kabupaten/Kota Jawa Barat</h2>
        </div>
        <div id="map"></div>
        <script>
            ...
            let jumlah_gurus = @json($jumlah_guru);
            console.log(jumlah_gurus);


            function createCircleMarker(jumlah_guru) {
                var circle = L.circleMarker([jumlah_guru.latitude, jumlah_guru.longitude], {
                ...
                var popupContent = '<table>' +
                    '<tr><th>Kabupaten/Kota</th><td>:</td><td>' + jumlah_guru.name + '</td></tr>' +
                    '<tr><th>Jumlah Guru</th><td>:</td><td>' + jumlah_guru.jumlah_guru + '</td></tr>' +
                    '</table>';
            ...
            jumlah_gurus.forEach(createCircleMarker);
