...
<head>
    ...
    <body>
        ...
        <div>
            <h2 style='text-align: center'>Jumlah Pendidikan S1 Kabupaten/Kota Jawa Barat</h2>
        </div>
        <div id="map"></div>
        <script>
            ...
            let jumlah_pendidikan_s1s = @json($jumlah_pendidikan_s1);
            console.log(jumlah_pendidikan_s1s);


            function createCircleMarker(jumlah_pendidikan_s1) {
                var circle = L.circleMarker([jumlah_pendidikan_s1.latitude, jumlah_pendidikan_s1.longitude], {
                ...
                var popupContent = '<table>' +
                    '<tr><th>Kabupaten/Kota</th><td>:</td><td>' + jumlah_pendidikan_s1.name + '</td></tr>' +
                    '<tr><th>Jumlah Pendidikan S1</th><td>:</td><td>' + jumlah_pendidikan_s1.jumlah_pendidikan_s1 + '</td></tr>' +
                    '</table>';
            ...
            jumlah_pendidikan_s1s.forEach(createCircleMarker);
