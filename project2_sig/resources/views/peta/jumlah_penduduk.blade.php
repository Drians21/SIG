...
<head>
    ...
    <body>
        ...
        <div>
            <h2 style='text-align: center'>Jumlah Penduduk Kabupaten/Kota Jawa Barat</h2>
        </div>
        <div id="map"></div>
        <script>
            ...
            let jumlah_penduduks = @json($jumlah_penduduk);
            console.log(jumlah_penduduks);


            function createCircleMarker(jumlah_penduduk) {
                var circle = L.circleMarker([jumlah_penduduk.latitude, jumlah_penduduk.longitude], {
                ...
                var popupContent = '<table>' +
                    '<tr><th>Kabupaten/Kota</th><td>:</td><td>' + jumlah_penduduk.name + '</td></tr>' +
                    '<tr><th>Jumlah Penduduk</th><td>:</td><td>' + jumlah_penduduk.jumlah_penduduk + '</td></tr>' +
                    '</table>';
            ...
            jumlah_penduduks.forEach(createCircleMarker);
